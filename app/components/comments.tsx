...
export default function Comments({ postId }: CommentsProps) {
    ...
    return (
        <div className="mt-8 pt-8 border-t border-zinc-200 dark:border-zinc-800">
            ...
            {/* Sidebar */}
            <div
                className={`fixed inset-y-0 right-0 w-full md:w-100 xl:w-1/4 bg-white dark:bg-[#09090b] shadow-2xl z-50 flex flex-col md:border-l md:border-zinc-200 dark:border-zinc-800 ${
